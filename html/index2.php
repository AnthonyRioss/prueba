    ...
    <header>
        <div class="header-content">
            <div class="menu" id="show-menu">
                <nav>
                    <p OnClick="location.href='../html/index2.php'" style="font-weight: 700; font-size: 24px;">HEALTHYHOME</p>
    ...
    <section>
        ...
        <div class="funciones">
            ...
            <div class="fn_fila">
                ...
                <div class="fn_cont" onclick="location='../back con front/inventario-agregar.php'">
                    <p>Inventario</p>
